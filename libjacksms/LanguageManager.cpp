...
namespace libJackSMS
{
    ...
    LanguageManager::LanguageManager():isSet(false),lan_iterator_counter(0){
        ...
        l.setString("19","Izbrii selektovano");
        ...
        l.setString("24","Auriraj");
        l.setString("25","Izbrii");
