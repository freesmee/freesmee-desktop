...
namespace libJackSMS{
    namespace dataTypes{
        paginaServizio::paginaServizio():captcha(false),conter_iter_headers(0),conter_iter_variables(0),counter_iter_contents(0),ha_condizione(false),counter_iter_commands(0){
        ...
        bool paginaServizio::checkErrors(){
            QList<pageError>::const_iterator i=errori.begin();
            QList<pageError>::const_iterator i_end=errori.end();
            for(;i!=i_end;++i){
        ...
        bool paginaServizio::checkAccepts(){
            QList<pageAccept>::const_iterator i=accettanti.begin();
            QList<pageAccept>::const_iterator i_end=accettanti.end();
            for(;i!=i_end;++i){
